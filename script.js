/* ============================================================
   MOTE CON HUESILLOS LA RECETA DE LA ABUELA — datos y lógica
   ============================================================
   ...
   que hay que preguntarles.
   ⚠️ Su cartel dice "SOLO PARA LLEVAR" y Google dice consumo en el lugar
   y para llevar. También hay que aclararlo.
   ============================================================ */

const MENU = {
  "mote": {
    "label": "Mote con huesillo",
    "items": [
      {
        "n": "Vaso grande",
        "p": 1000,
...
/* ---------- INDICADOR ABIERTO / CERRADO ----------
   ⚠️ Google confirma que CIERRA a las 20:00. La hora de apertura NO está publicada: se asume 11:00 como estimación y así se declara en Visítanos. */
